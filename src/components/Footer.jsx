...
const Footer = () => {
  ...
  return (
    <footer
      ...
      style={{
        background:
          "linear-gradient(120deg, #1e293b 0%, #2563eb 60%, #38bdf8 100%)",
      }}
    >
      <style>
        {`
      ...
      <div
        ...
        style={{
          ...
          height: "320px",
          background:
            "radial-gradient(circle at 30% 30%, #38bdf8 0%, transparent 70%)",
        }}
      />
      <div
        className="footer-bg-blur"
        style={{
          ...
          height: "260px",
          background:
            "radial-gradient(circle at 70% 70%, #2563eb 0%, transparent 70%)",
        }}
      />
      <div className="relative z-10 container mx-auto px-6 py-14">
        <div className="grid md:grid-cols-4 gap-10">
          <div className={fadeInVariants[0]}>
            <h3 className="text-2xl font-extrabold mb-4 tracking-wide footer-brand-gradient footer-animate-fade-in-up">
              MountSol
            </h3>
            <p className="text-blue-100/90 font-medium footer-animate-fade-in-up delay-100">
          ...
          <div className={fadeInVariants[1]}>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  to="/"
                  className="text-blue-100/80 footer-link footer-animate-fade-in-up delay-100"
                >
                  Home
                </Link>
              </li>
              <li>
                <Link
                  to="/industries"
                  className="text-blue-100/80 footer-link footer-animate-fade-in-up delay-200"
                >
                  Industries
                </Link>
              </li>
              <li>
                <Link
                  to="/projects"
                  className="text-blue-100/80 footer-link footer-animate-fade-in-up delay-300"
                >
                  Projects
                </Link>
              </li>
          ...
          <div className={fadeInVariants[3]}>
            ...
            <address className="not-italic text-blue-100/80 font-medium footer-animate-fade-in-up delay-100">
              <p className="footer-contact-gradient">
                Plot 35, Aibak Block Garden Town,
              </p>
              <p className="footer-contact-gradient">Lahore, Punjab 54000</p>
              <p className="mt-2 footer-contact-gradient">usman@mountsol.com</p>
              <p className="footer-contact-gradient">+92 341 4891548</p>
            </address>
          </div>
        </div>

        <div className="border-t border-blue-200/30 mt-14 pt-8 text-center">
          <p className="footer-copyright footer-animate-fade-in-up delay-300">
            &copy; {new Date().getFullYear()} MountSol. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
